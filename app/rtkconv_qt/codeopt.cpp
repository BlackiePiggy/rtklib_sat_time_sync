...
void CodeOptDialog::UpdateEnable(void)
{
    ...
    I52->setEnabled((NavSys&SYS_IRN)&&(FreqType&FREQTYPE_S));
    I53->setEnabled((NavSys&SYS_IRN)&&(FreqType&FREQTYPE_S));
    I54->setEnabled((NavSys&SYS_IRN)&&(FreqType&FREQTYPE_S));
    I55->setEnabled((NavSys&SYS_IRN)&&(FreqType&FREQTYPE_S));
